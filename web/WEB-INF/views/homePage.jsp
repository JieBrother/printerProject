...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header header-demo" lay-filter="demo1">
        <div class="layui-main layui-bg-green">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect="" lay-filter="me">
                    <a href="javascript:;"><img src="${pageContext.request.contextPath}/static/头像.jpg" class="layui-nav-img">${sessionScope.user.id}|${sessionScope.user.name}</a>
    ...
    <div class="layui-body">
        <table class="layui-table" id="tableData"
            ...
            <tr>
                ...
                <th lay-data="{fixed: 'right', title:'操作', align:'center', toolbar: '#operation', width:150}">操作
                </th>
            </tr>
            </thead>
        </table>
    ...
    <script type="text/html" id="operation">
        ...
        <a class='layui-btn layui-btn-normal layui-btn-xs' style="background: #FF5722" lay-event='del'>取消打印</a>
        {{#  } }}
        {{#  if(d.id != '${sessionScope.user.id}'){ }}
        无法操作
        {{#  } }}
            ...
            table.on('tool(printerData)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'del') { //删除
                    layer.confirm('是否取消打印', function (index) {
                        ...
                        //向服务端发送删除指令
                        $.ajax({
                            url: '${pageContext.request.contextPath}/exitPrint',
                            data: {
