...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main layui-bg-green">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect="" lay-filter="me">
                    <a href="javascript:;"><img src="${pageContext.request.contextPath}/static/头像.jpg" class="layui-nav-img" id="userName">管理员-${sessionScope.user.name}</a>
    ...
    <div class="layui-body">
        ...
        <table class="layui-table" id="tableData"
               lay-data="{height: 'full-200', cellMinWidth: 80,url:'${pageContext.request.contextPath}/historyList', id:'test', limit: 10}"
               lay-filter="adminHistoryData">
            <thead>
            <tr>
    ...
    <script type="text/html" id="operation">
        ...
        <a class='layui-btn layui-btn-normal layui-btn-xs' style="background: #FF5722" lay-event='del'>删除订单</a>
    ...
    <script>
        ...
        layui.use(['element', 'layer', 'form', 'table'], function () {
            ...
            table.on('tool(adminHistoryData)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                var data = obj.data; //获得当前行数据
                var layEvent = obj.event; //获得 lay-event 对应的值（也可以是表头的 event 参数对应的值）
                var tr = obj.tr; //获得当前行 tr 的 DOM 对象（如果有的话）

                if (layEvent === 'del') { //删除
                    layer.confirm('是否删除订单信息', function (index) {
                        obj.del(); //删除对应行（tr）的DOM结构，并更新缓存
                        layer.close(index);
                        //向服务端发送删除指令
                        $.ajax({
                            url: '/printerProject/delHistoryData',
                            data: {
